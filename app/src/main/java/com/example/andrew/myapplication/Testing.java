...
public class Testing extends AppCompatActivity {
        ...
        protected void onCreate(Bundle savedInstanceState) {
            ...
            btnSend.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    writeData(x.getText(), y.getText(), xax.getText(), yax.getText(), cbt.getText(), zbt.getText());
                }
            });
        }
        ...
        private DataStructure createData(Editable x, Editable y, Editable xax, Editable yax, Editable cbt, Editable zbt){
            Long time = System.currentTimeMillis()/1000;
            String timestamp = time.toString();
            return new DataStructure(String.valueOf(x),
                    String.valueOf(y),
                    String.valueOf(xax),
                    String.valueOf(yax),
                    String.valueOf(cbt),
        ...
        private void writeData(Editable x, Editable y, Editable xax, Editable yax, Editable cbt, Editable zbt) {

            DataStructure mData = createData(x, y, xax, yax, cbt, zbt);
